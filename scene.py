...
if __name__ == '__main__':
    ...
    renderer = Animate(screen, camera, [mesh_1,mesh_2,mesh_3], light)
    renderer.animate([80,80,80], [0.2, 0.2, 0.2], "horizontal", "mlaa")
    #renderer.createFrames([80,80,80], [0.2, 0.2, 0.2], "horizontal", "mlaa")
    #renderer.testFrameRate([80,80,80], [0.2, 0.2, 0.2], "horizontal", "mlaa")
